...
uint256 hashGenesisBlock("0xc04cd4bc23b3863137bf873a61d7d6ea2710ca5b202cd18de4cd7eedfe105759");
...
int64 nChainStartTime = 1412398598;
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    } else if (nHeight > 1 && nHeight < 8000) nSubsidy = 0;

    // Subsidy is cut in half every 350400 blocks, which will occur approximately every year.
    nSubsidy >>= (nHeight / 350400); // WiseCoin: 350400 blocks in ~1 year

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60 * 60; // WiseCoin: every hour
static const int64 nTargetSpacing = 1.5 * 60; // WiseCoin: 1.5 minutes
...
unsigned int static KimotoGravityWell(const CBlockIndex* pindexLast, const CBlockHeader *pblock, uint64 TargetBlocksSpacingSeconds, uint64 PastBlocksMin, uint64 PastBlocksMax) {
	...
	for (unsigned int i = 1; BlockReading && BlockReading->nHeight > 0; i++) {
		...
		if (LatestBlockTime < BlockReading->GetBlockTime()) {
                ...
                PastRateActualSeconds                   = LatestBlockTime - BlockReading->GetBlockTime();		PastRateTargetSeconds			= TargetBlocksSpacingSeconds * PastBlocksMass;
...
{
    // WiseCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        pchMessageStart[2] = 'S';
        pchMessageStart[3] = 'E';
        hashGenesisBlock = uint256("0x2c73b95c072d61a3dfd21563b480c46c33e933437cbd9365d1734953ee61ef72");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "10/3/2014 NYTimes Texas Narrows Focus to 10 Seen as at Greatest Risk for Ebola";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1412398598;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3844688;
        ...
        assert(block.hashMerkleRoot == uint256("0xf42ae4a7a8a377b5bf33f6ad9afadb7b550d28e7fee9f70e6e3298a257ff2c40"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // WiseCoin: increase each by adding 2 to bitcoin's value.
